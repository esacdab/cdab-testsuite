    ...
    stages {
        ...
        stage('Build & Publish Docker') {
            steps {
                ...
                sh "mv src/cdab-client/build/RPMS/noarch/cdab-client-*.rpm ${WORKSPACE}/src/docker/"
                sh "mv src/cdab-remote-client/build/RPMS/noarch/cdab-remote-client-*.rpm ${WORKSPACE}/src/docker/"
                script {
